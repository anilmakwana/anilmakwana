        ...
        <div class="row align-items-center full-height">
            <div class="col-12 col-xl-6 mx-auto m-w-600">
                <div class="bg-white rounded pt-15 pt-lg-30">
                    ...
                    <div class="title-style-1 title-with-border title-with-small-border px-30 px-md-30">Signup Form</div>
                    <div class="p-30 px-md-80">
                        <form action="{{route('adduser')}}" method="post">
                            ...
                            <div class="form-group position-relative">
                                ...
                                <div class="pre-icon fingerprint"><i class="far fa-envelope"></i></div>
                            </div>
                            <div class="form-group position-relative">
                                <label for=""> Password </label>
                                <input class="form-control" name="password" type="text">
                                <div class="pre-icon fingerprint"><i class="far fa-password"></i></div>
                            </div>
                          
                            <div class="buttons-w"> <button class="btn btn-info" type="submit">Signup</button>                            
                            </div>
                        </form>
                    </div>
                </div>
